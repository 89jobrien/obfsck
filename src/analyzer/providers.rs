//! Adapts Ollama, OpenAI, and Anthropic HTTP APIs to the analyzer provider interface.

// TODO(roadmap-providers): Build a shared provider pipeline with retries and bounded concurrency.
